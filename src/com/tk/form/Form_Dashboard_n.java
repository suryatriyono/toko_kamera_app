 ...
 * @author STNVC
 */
public class Form_Dashboard_n extends javax.swing.JPanel {
    ...
    private JPanel createInfoPanel() {
        ...
        Card card1 = new Card();
        card1.setPreferredSize(new Dimension(500, 250));
